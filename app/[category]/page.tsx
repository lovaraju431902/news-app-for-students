...
// import FilesMaterialsView from "@/components/FilesMaterialsView";
...
//     return {
//       title: "AI Prompts Library | Students Hub",
//       description: "Search, view, copy and generate amazing images using our library of curated AI prompts.",
//     };
//   }
//   if (category === "files-materials") {
//     return {
//       title: "Study Files & Materials | Students Hub",
//       description: "Download PDFs, notes, documents, files and educational materials directly on Students Hub.",
//     };
//   }
...
//             <CategoriesSidebar />
//             <div className="flex-grow py-6 flex-1 min-w-0 pr-3 md:pr-0">
//               <AIPromptsView categoryTag={category} />
//             </div>
//           </div>
//         </main>
//         <Footer />
...
import FilesMaterialsView from "@/components/FilesMaterialsView";
import InfiniteCategoryBlogs from "@/components/InfiniteCategoryBlogs";
import AIPromptsView from "@/components/AIPromptsView";
...
export default async function CategoryPage({ params }: PageProps) {
  ...
  if (category === "ai-prompts") {
    return (
      <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-955 dark:text-zinc-50 flex flex-col font-sans">
        <Topbar />
        <Header />
        <Navbar />
        <main className="flex-grow pl-3 md:pl-0 w-full">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <CategoriesSidebar />
            <div className="flex-grow py-6 flex-1 min-w-0">
              <AIPromptsView categoryTag={categoryTag} />
            </div>
          </div>
        </main>
        <Footer />
      ...
      <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-955 dark:text-zinc-50 flex flex-col font-sans">
        ...
        <main className="flex-grow pl-3 md:pl-0 w-full">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <CategoriesSidebar />
            <div className="flex-grow py-6 flex-1 min-w-0">
              <FilesMaterialsView categoryTag={categoryTag} />
            </div>
          </div>
        </main>
        <Footer />
    ...
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-955 dark:text-zinc-50 flex flex-col font-sans">
      ...
      <main className="flex-grow pl-3 md:pl-0 w-full">
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          {/* Middle Column: Blog List with scroll pagination */}
          <InfiniteCategoryBlogs categoryTag={categoryTag} categorySlug={category} />
        </div>
      </main>
